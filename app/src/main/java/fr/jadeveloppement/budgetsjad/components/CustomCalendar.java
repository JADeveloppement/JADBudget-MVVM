...
public class CustomCalendar extends LinearLayout {
    ...
    public void setCalendarDayLayoutHeight(int height) throws Exception {
        ...
        else if (height <= 50) Log.w(TAG, "CustomCalendar > setCalendarDayLayoutHeight : height given ( "+height+" ) may be too small.");
    ...
    public void setMonthLayout(){
        ...
        prevMonth.setText("<");
        tvMonth.setText(monthesLong[parseInt(getMonth())] + " " + getYear());
        nextMonth.setText(">");
     ...
     * @return LinearLayout with 7 TextViews that has the name of the days of a week
     */
    ...
    private void setDaysLayout(){
        ...
        for (int week = 0; week < (int) Math.ceil((firstDayOfWeek + daysOfMonth) / 7.0); week++) {
            ...
            for (int dayOfWeek = 0; dayOfWeek < 7; dayOfWeek++) {
                ...
                dayOfWeekTv.setTextAlignment(DAYTV_TXT_ALIGNEMENT);
                dayOfWeekTv.setPadding(DAYTV_PADDING_LEFT, DAYTV_PADDING_TOP, DAYTV_PADDING_RIGHT, DAYTV_PADDING_BOTTOM);
                ...
                if ((week == 0 && dayOfWeek >= firstDayOfWeek) || (week > 0 && dayOfMonth <= daysOfMonth)){
                    ...
                    makeDayLayoutActive(dayOfWeekLayout, dayOfWeekTv, dayOfMonth == parseInt(calendarDay));
